...
func (m *NetworktemplateLogicFilterRulesModel) PutExpand(to *ipam.NetworktemplateLogicFilterRules) *ipam.NetworktemplateLogicFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range NetworktemplateLogicFilterRulesResourceSchemaAttributes {
