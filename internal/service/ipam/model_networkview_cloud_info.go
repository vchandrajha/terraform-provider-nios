...
func (m *NetworkviewCloudInfoModel) PutExpand(to *ipam.NetworkviewCloudInfo) *ipam.NetworkviewCloudInfo {
	if m == nil {
		return nil
	}
	...
	for field, attr := range NetworkviewCloudInfoResourceSchemaAttributes {
