...
func (m *Ipv6networkFederatedRealmsModel) PutExpand(to *ipam.Ipv6networkFederatedRealms) *ipam.Ipv6networkFederatedRealms {
	if m == nil {
		return nil
	}
	...
	for field, attr := range Ipv6networkFederatedRealmsResourceSchemaAttributes {
