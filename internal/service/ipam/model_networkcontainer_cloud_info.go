...
func (m *NetworkcontainerCloudInfoModel) PutExpand(to *ipam.NetworkcontainerCloudInfo) *ipam.NetworkcontainerCloudInfo {
	if m == nil {
		return nil
	}
	...
	for field, attr := range NetworkcontainerCloudInfoResourceSchemaAttributes {
