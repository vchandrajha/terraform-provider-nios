...
func (m *NetworkFederatedRealmsModel) PutExpand(to *ipam.NetworkFederatedRealms) *ipam.NetworkFederatedRealms {
	if m == nil {
		return nil
	}
	...
	for field, attr := range NetworkFederatedRealmsResourceSchemaAttributes {
