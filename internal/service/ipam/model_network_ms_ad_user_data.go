...
func (m *NetworkMsAdUserDataModel) PutExpand(to *ipam.NetworkMsAdUserData) *ipam.NetworkMsAdUserData {
	if m == nil {
		return nil
	}
	...
	for field, attr := range NetworkMsAdUserDataResourceSchemaAttributes {
