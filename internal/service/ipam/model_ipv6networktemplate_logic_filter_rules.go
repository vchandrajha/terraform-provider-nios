...
func (m *Ipv6networktemplateLogicFilterRulesModel) PutExpand(to *ipam.Ipv6networktemplateLogicFilterRules) *ipam.Ipv6networktemplateLogicFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range Ipv6networktemplateLogicFilterRulesResourceSchemaAttributes {
