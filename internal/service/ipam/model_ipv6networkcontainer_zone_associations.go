...
func (m *Ipv6networkcontainerZoneAssociationsModel) PutExpand(to *ipam.Ipv6networkcontainerZoneAssociations) *ipam.Ipv6networkcontainerZoneAssociations {
	if m == nil {
		return nil
	}
	...
	for field, attr := range Ipv6networkcontainerZoneAssociationsResourceSchemaAttributes {
