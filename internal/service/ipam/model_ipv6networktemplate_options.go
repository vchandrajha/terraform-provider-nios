...
func (m *Ipv6networktemplateOptionsModel) PutExpand(to *ipam.Ipv6networktemplateOptions) *ipam.Ipv6networktemplateOptions {
	if m == nil {
		return nil
	}
	...
	for field, attr := range Ipv6networktemplateOptionsResourceSchemaAttributes {
