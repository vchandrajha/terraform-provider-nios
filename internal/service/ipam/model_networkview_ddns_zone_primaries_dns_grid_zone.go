...
func (m *NetworkviewDdnsZonePrimariesDnsGridZoneModel) PutExpand(to *ipam.NetworkviewDdnsZonePrimariesDnsGridZone) *ipam.NetworkviewDdnsZonePrimariesDnsGridZone {
	if m == nil {
		return nil
	}
	...
	for field, attr := range NetworkviewDdnsZonePrimariesDnsGridZoneResourceSchemaAttributes {
