...
func (m *NetworktemplateDelegatedMemberModel) PutExpand(to *ipam.NetworktemplateDelegatedMember) *ipam.NetworktemplateDelegatedMember {
	if m == nil {
		return nil
	}
	...
	for field, attr := range NetworktemplateDelegatedMemberResourceSchemaAttributes {
