...
func (m *NetworktemplateOptionsModel) PutExpand(to *ipam.NetworktemplateOptions) *ipam.NetworktemplateOptions {
	if m == nil {
		return nil
	}
	...
	for field, attr := range NetworktemplateOptionsResourceSchemaAttributes {
