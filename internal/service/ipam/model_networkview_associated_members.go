...
func (m *NetworkviewAssociatedMembersModel) PutExpand(to *ipam.NetworkviewAssociatedMembers) *ipam.NetworkviewAssociatedMembers {
	if m == nil {
		return nil
	}
	...
	for field, attr := range NetworkviewAssociatedMembersResourceSchemaAttributes {
