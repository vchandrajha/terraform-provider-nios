...
func (m *NetworkLogicFilterRulesModel) PutExpand(to *ipam.NetworkLogicFilterRules) *ipam.NetworkLogicFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range NetworkLogicFilterRulesResourceSchemaAttributes {
