...
func (m *VdiscoverytaskScheduledRunModel) PutExpand(to *discovery.VdiscoverytaskScheduledRun) *discovery.VdiscoverytaskScheduledRun {
	if m == nil {
		return nil
	}
	...
	for field, attr := range VdiscoverytaskScheduledRunResourceSchemaAttributes {
