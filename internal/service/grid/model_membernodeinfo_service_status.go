...
func (m *MembernodeinfoServiceStatusModel) PutExpand(to *grid.MembernodeinfoServiceStatus) *grid.MembernodeinfoServiceStatus {
	if m == nil {
		return nil
	}
	...
	for field, attr := range MembernodeinfoServiceStatusResourceSchemaAttributes {
