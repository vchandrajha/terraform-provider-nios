...
func (m *LdapAuthServiceEaMappingModel) PutExpand(to *security.LdapAuthServiceEaMapping) *security.LdapAuthServiceEaMapping {
	if m == nil {
		return nil
	}
	...
	for field, attr := range LdapAuthServiceEaMappingResourceSchemaAttributes {
