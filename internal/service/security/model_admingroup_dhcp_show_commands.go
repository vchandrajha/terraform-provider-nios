...
func (m *AdmingroupDhcpShowCommandsModel) PutExpand(to *security.AdmingroupDhcpShowCommands) *security.AdmingroupDhcpShowCommands {
	if m == nil {
		return nil
	}
	...
	for field, attr := range AdmingroupDhcpShowCommandsResourceSchemaAttributes {
