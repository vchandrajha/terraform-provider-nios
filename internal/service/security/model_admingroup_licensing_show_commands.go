...
func (m *AdmingroupLicensingShowCommandsModel) PutExpand(to *security.AdmingroupLicensingShowCommands) *security.AdmingroupLicensingShowCommands {
	if m == nil {
		return nil
	}
	...
	for field, attr := range AdmingroupLicensingShowCommandsResourceSchemaAttributes {
