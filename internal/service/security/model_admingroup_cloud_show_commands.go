...
func (m *AdmingroupCloudShowCommandsModel) PutExpand(to *security.AdmingroupCloudShowCommands) *security.AdmingroupCloudShowCommands {
	if m == nil {
		return nil
	}
	...
	for field, attr := range AdmingroupCloudShowCommandsResourceSchemaAttributes {
