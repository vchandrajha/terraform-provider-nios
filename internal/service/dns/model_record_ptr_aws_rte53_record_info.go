...
func (m *RecordPtrAwsRte53RecordInfoModel) PutExpand(to *dns.RecordPtrAwsRte53RecordInfo) *dns.RecordPtrAwsRte53RecordInfo {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordPtrAwsRte53RecordInfoResourceSchemaAttributes {
