...
func (m *RecordPtrMsAdUserDataModel) PutExpand(to *dns.RecordPtrMsAdUserData) *dns.RecordPtrMsAdUserData {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordPtrMsAdUserDataResourceSchemaAttributes {
