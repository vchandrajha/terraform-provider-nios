...
func (m *ZonestubstubmembersPreferredPrimariesModel) PutExpand(to *dns.ZonestubstubmembersPreferredPrimaries) *dns.ZonestubstubmembersPreferredPrimaries {
	if m == nil {
		return nil
	}
	...
	for field, attr := range ZonestubstubmembersPreferredPrimariesResourceSchemaAttributes {
