...
func (m *NsgroupGridSecondariesModel) PutExpand(to *dns.NsgroupGridSecondaries) *dns.NsgroupGridSecondaries {
	if m == nil {
		return nil
	}
	...
	for field, attr := range NsgroupGridSecondariesResourceSchemaAttributes {
