...
func (m *RecordHostCloudInfoModel) PutExpand(to *dns.RecordHostCloudInfo) *dns.RecordHostCloudInfo {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordHostCloudInfoResourceSchemaAttributes {
