...
func (m *RecordHostIpv4addrMsAdUserDataModel) PutExpand(to *dns.RecordHostIpv4addrMsAdUserData) *dns.RecordHostIpv4addrMsAdUserData {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordHostIpv4addrMsAdUserDataResourceSchemaAttributes {
