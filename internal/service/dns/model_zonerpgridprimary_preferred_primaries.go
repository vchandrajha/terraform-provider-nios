...
func (m *ZonerpgridprimaryPreferredPrimariesModel) PutExpand(to *dns.ZonerpgridprimaryPreferredPrimaries) *dns.ZonerpgridprimaryPreferredPrimaries {
	if m == nil {
		return nil
	}
	...
	for field, attr := range ZonerpgridprimaryPreferredPrimariesResourceSchemaAttributes {
