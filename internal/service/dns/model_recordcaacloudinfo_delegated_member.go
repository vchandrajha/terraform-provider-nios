...
func (m *RecordcaacloudinfoDelegatedMemberModel) PutExpand(to *dns.RecordcaacloudinfoDelegatedMember) *dns.RecordcaacloudinfoDelegatedMember {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordcaacloudinfoDelegatedMemberResourceSchemaAttributes {
