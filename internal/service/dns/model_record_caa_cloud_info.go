...
func (m *RecordCaaCloudInfoModel) PutExpand(to *dns.RecordCaaCloudInfo) *dns.RecordCaaCloudInfo {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordCaaCloudInfoResourceSchemaAttributes {
