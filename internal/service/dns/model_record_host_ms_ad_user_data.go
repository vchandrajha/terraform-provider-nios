...
func (m *RecordHostMsAdUserDataModel) PutExpand(to *dns.RecordHostMsAdUserData) *dns.RecordHostMsAdUserData {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordHostMsAdUserDataResourceSchemaAttributes {
