...
func (m *RecordSrvCloudInfoModel) PutExpand(to *dns.RecordSrvCloudInfo) *dns.RecordSrvCloudInfo {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordSrvCloudInfoResourceSchemaAttributes {
