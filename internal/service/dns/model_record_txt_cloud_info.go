...
func (m *RecordTxtCloudInfoModel) PutExpand(to *dns.RecordTxtCloudInfo) *dns.RecordTxtCloudInfo {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordTxtCloudInfoResourceSchemaAttributes {
