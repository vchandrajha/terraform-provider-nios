...
func (m *RecordHostIpv4addrOptionsModel) PutExpand(to *dns.RecordHostIpv4addrOptions) *dns.RecordHostIpv4addrOptions {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordHostIpv4addrOptionsResourceSchemaAttributes {
