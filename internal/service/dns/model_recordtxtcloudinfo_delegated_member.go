...
func (m *RecordtxtcloudinfoDelegatedMemberModel) PutExpand(to *dns.RecordtxtcloudinfoDelegatedMember) *dns.RecordtxtcloudinfoDelegatedMember {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordtxtcloudinfoDelegatedMemberResourceSchemaAttributes {
