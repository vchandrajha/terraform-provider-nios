...
func (m *RecordHostIpv4addrLogicFilterRulesModel) PutExpand(to *dns.RecordHostIpv4addrLogicFilterRules) *dns.RecordHostIpv4addrLogicFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordHostIpv4addrLogicFilterRulesResourceSchemaAttributes {
