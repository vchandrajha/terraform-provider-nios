...
func (m *RecordTlsaCloudInfoModel) PutExpand(to *dns.RecordTlsaCloudInfo) *dns.RecordTlsaCloudInfo {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordTlsaCloudInfoResourceSchemaAttributes {
