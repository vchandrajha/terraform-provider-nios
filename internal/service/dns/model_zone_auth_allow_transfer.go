...
func (m *ZoneAuthAllowTransferModel) PutExpand(to *dns.ZoneAuthAllowTransfer) *dns.ZoneAuthAllowTransfer {
	if m == nil {
		return nil
	}
	...
	for field, attr := range ZoneAuthAllowTransferResourceSchemaAttributes {
