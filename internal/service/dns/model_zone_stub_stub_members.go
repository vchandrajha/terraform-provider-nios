...
func (m *ZoneStubStubMembersModel) PutExpand(to *dns.ZoneStubStubMembers) *dns.ZoneStubStubMembers {
	if m == nil {
		return nil
	}
	...
	for field, attr := range ZoneStubStubMembersResourceSchemaAttributes {
