...
func (m *RecordacloudinfoDelegatedMemberModel) PutExpand(to *dns.RecordacloudinfoDelegatedMember) *dns.RecordacloudinfoDelegatedMember {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordacloudinfoDelegatedMemberResourceSchemaAttributes {
