...
func (m *RecordAaaaMsAdUserDataModel) PutExpand(to *dns.RecordAaaaMsAdUserData) *dns.RecordAaaaMsAdUserData {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordAaaaMsAdUserDataResourceSchemaAttributes {
