...
func (m *RecordAaaaDiscoveredDataModel) PutExpand(to *dns.RecordAaaaDiscoveredData) *dns.RecordAaaaDiscoveredData {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordAaaaDiscoveredDataResourceSchemaAttributes {
