...
func (m *RecordAMsAdUserDataModel) PutExpand(to *dns.RecordAMsAdUserData) *dns.RecordAMsAdUserData {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RecordAMsAdUserDataResourceSchemaAttributes {
