...
func (m *ViewLastQueriedAclModel) PutExpand(to *dns.ViewLastQueriedAcl) *dns.ViewLastQueriedAcl {
	if m == nil {
		return nil
	}
	...
	for field, attr := range ViewLastQueriedAclResourceSchemaAttributes {
