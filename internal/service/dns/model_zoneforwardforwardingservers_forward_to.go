...
func (m *ZoneforwardforwardingserversForwardToModel) PutExpand(to *dns.ZoneforwardforwardingserversForwardTo) *dns.ZoneforwardforwardingserversForwardTo {
	if m == nil {
		return nil
	}
	...
	for field, attr := range ZoneforwardforwardingserversForwardToResourceSchemaAttributes {
