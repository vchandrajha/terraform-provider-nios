...
func (m *RangeRelayAgentFilterRulesModel) PutExpand(to *dhcp.RangeRelayAgentFilterRules) *dhcp.RangeRelayAgentFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangeRelayAgentFilterRulesResourceSchemaAttributes {
