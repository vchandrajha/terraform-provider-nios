...
func (m *RangeMacFilterRulesModel) PutExpand(to *dhcp.RangeMacFilterRules) *dhcp.RangeMacFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangeMacFilterRulesResourceSchemaAttributes {
