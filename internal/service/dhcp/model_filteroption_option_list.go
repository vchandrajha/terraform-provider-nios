...
func (m *FilteroptionOptionListModel) PutExpand(to *dhcp.FilteroptionOptionList) *dhcp.FilteroptionOptionList {
	if m == nil {
		return nil
	}
	...
	for field, attr := range FilteroptionOptionListResourceSchemaAttributes {
