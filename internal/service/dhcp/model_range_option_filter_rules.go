...
func (m *RangeOptionFilterRulesModel) PutExpand(to *dhcp.RangeOptionFilterRules) *dhcp.RangeOptionFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangeOptionFilterRulesResourceSchemaAttributes {
