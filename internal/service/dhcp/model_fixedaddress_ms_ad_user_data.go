...
func (m *FixedaddressMsAdUserDataModel) PutExpand(to *dhcp.FixedaddressMsAdUserData) *dhcp.FixedaddressMsAdUserData {
	if m == nil {
		return nil
	}
	...
	for field, attr := range FixedaddressMsAdUserDataResourceSchemaAttributes {
