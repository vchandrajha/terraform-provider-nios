...
func (m *FixedaddressCloudInfoModel) PutExpand(to *dhcp.FixedaddressCloudInfo) *dhcp.FixedaddressCloudInfo {
	if m == nil {
		return nil
	}
	...
	for field, attr := range FixedaddressCloudInfoResourceSchemaAttributes {
