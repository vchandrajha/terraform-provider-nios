...
func (m *SharednetworkLogicFilterRulesModel) PutExpand(to *dhcp.SharednetworkLogicFilterRules) *dhcp.SharednetworkLogicFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range SharednetworkLogicFilterRulesResourceSchemaAttributes {
