...
func (m *SharednetworkMsAdUserDataModel) PutExpand(to *dhcp.SharednetworkMsAdUserData) *dhcp.SharednetworkMsAdUserData {
	if m == nil {
		return nil
	}
	...
	for field, attr := range SharednetworkMsAdUserDataResourceSchemaAttributes {
