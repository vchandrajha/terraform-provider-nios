...
func (m *SharednetworkNetworksModel) PutExpand(to *dhcp.SharednetworkNetworks) *dhcp.SharednetworkNetworks {
	if m == nil {
		return nil
	}
	...
	for field, attr := range SharednetworkNetworksResourceSchemaAttributes {
