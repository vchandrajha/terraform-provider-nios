...
func (m *RangetemplateMacFilterRulesModel) PutExpand(to *dhcp.RangetemplateMacFilterRules) *dhcp.RangetemplateMacFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangetemplateMacFilterRulesResourceSchemaAttributes {
