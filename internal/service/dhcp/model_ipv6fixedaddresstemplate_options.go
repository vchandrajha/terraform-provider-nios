...
func (m *Ipv6fixedaddresstemplateOptionsModel) PutExpand(to *dhcp.Ipv6fixedaddresstemplateOptions) *dhcp.Ipv6fixedaddresstemplateOptions {
	if m == nil {
		return nil
	}
	...
	for field, attr := range Ipv6fixedaddresstemplateOptionsResourceSchemaAttributes {
