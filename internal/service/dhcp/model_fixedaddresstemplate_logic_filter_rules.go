...
func (m *FixedaddresstemplateLogicFilterRulesModel) PutExpand(to *dhcp.FixedaddresstemplateLogicFilterRules) *dhcp.FixedaddresstemplateLogicFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range FixedaddresstemplateLogicFilterRulesResourceSchemaAttributes {
