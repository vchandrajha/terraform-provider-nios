...
func (m *RangetemplateFingerprintFilterRulesModel) PutExpand(to *dhcp.RangetemplateFingerprintFilterRules) *dhcp.RangetemplateFingerprintFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangetemplateFingerprintFilterRulesResourceSchemaAttributes {
