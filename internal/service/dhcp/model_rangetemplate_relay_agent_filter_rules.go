...
func (m *RangetemplateRelayAgentFilterRulesModel) PutExpand(to *dhcp.RangetemplateRelayAgentFilterRules) *dhcp.RangetemplateRelayAgentFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangetemplateRelayAgentFilterRulesResourceSchemaAttributes {
