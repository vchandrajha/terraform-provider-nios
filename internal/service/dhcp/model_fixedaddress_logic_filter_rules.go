...
func (m *FixedaddressLogicFilterRulesModel) PutExpand(to *dhcp.FixedaddressLogicFilterRules) *dhcp.FixedaddressLogicFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range FixedaddressLogicFilterRulesResourceSchemaAttributes {
