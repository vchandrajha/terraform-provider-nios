...
func (m *RangesubscribesettingsMappedEaAttributesModel) PutExpand(to *dhcp.RangesubscribesettingsMappedEaAttributes) *dhcp.RangesubscribesettingsMappedEaAttributes {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangesubscribesettingsMappedEaAttributesResourceSchemaAttributes {
