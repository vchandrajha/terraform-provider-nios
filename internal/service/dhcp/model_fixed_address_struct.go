...
func (m *FixedAddressStructModel) PutExpand(to *dhcp.FixedAddressStruct) *dhcp.FixedAddressStruct {
	if m == nil {
		return nil
	}
	...
	for field, attr := range FixedAddressStructResourceSchemaAttributes {
