...
func (m *Ipv6fixedaddressLogicFilterRulesModel) PutExpand(to *dhcp.Ipv6fixedaddressLogicFilterRules) *dhcp.Ipv6fixedaddressLogicFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range Ipv6fixedaddressLogicFilterRulesResourceSchemaAttributes {
