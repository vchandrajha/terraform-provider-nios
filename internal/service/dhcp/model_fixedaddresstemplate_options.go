...
func (m *FixedaddresstemplateOptionsModel) PutExpand(to *dhcp.FixedaddresstemplateOptions) *dhcp.FixedaddresstemplateOptions {
	if m == nil {
		return nil
	}
	...
	for field, attr := range FixedaddresstemplateOptionsResourceSchemaAttributes {
