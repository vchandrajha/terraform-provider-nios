...
func (m *RangetemplateLogicFilterRulesModel) PutExpand(to *dhcp.RangetemplateLogicFilterRules) *dhcp.RangetemplateLogicFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangetemplateLogicFilterRulesResourceSchemaAttributes {
