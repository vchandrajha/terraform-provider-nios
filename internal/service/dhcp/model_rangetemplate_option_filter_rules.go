...
func (m *RangetemplateOptionFilterRulesModel) PutExpand(to *dhcp.RangetemplateOptionFilterRules) *dhcp.RangetemplateOptionFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangetemplateOptionFilterRulesResourceSchemaAttributes {
