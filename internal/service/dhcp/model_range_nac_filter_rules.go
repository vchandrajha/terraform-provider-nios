...
func (m *RangeNacFilterRulesModel) PutExpand(to *dhcp.RangeNacFilterRules) *dhcp.RangeNacFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangeNacFilterRulesResourceSchemaAttributes {
