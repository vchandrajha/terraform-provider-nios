...
func (m *Ipv6fixedaddressCliCredentialsModel) PutExpand(to *dhcp.Ipv6fixedaddressCliCredentials) *dhcp.Ipv6fixedaddressCliCredentials {
	if m == nil {
		return nil
	}
	...
	for field, attr := range Ipv6fixedaddressCliCredentialsResourceSchemaAttributes {
