...
func (m *Ipv6rangetemplateLogicFilterRulesModel) PutExpand(to *dhcp.Ipv6rangetemplateLogicFilterRules) *dhcp.Ipv6rangetemplateLogicFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range Ipv6rangetemplateLogicFilterRulesResourceSchemaAttributes {
