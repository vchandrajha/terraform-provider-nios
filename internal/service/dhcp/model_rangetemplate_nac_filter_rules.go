...
func (m *RangetemplateNacFilterRulesModel) PutExpand(to *dhcp.RangetemplateNacFilterRules) *dhcp.RangetemplateNacFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangetemplateNacFilterRulesResourceSchemaAttributes {
