...
func (m *RangeFingerprintFilterRulesModel) PutExpand(to *dhcp.RangeFingerprintFilterRules) *dhcp.RangeFingerprintFilterRules {
	if m == nil {
		return nil
	}
	...
	for field, attr := range RangeFingerprintFilterRulesResourceSchemaAttributes {
