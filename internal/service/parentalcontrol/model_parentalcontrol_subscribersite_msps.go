...
func (m *ParentalcontrolSubscribersiteMspsModel) PutExpand(to *parentalcontrol.ParentalcontrolSubscribersiteMsps) *parentalcontrol.ParentalcontrolSubscribersiteMsps {
	if m == nil {
		return nil
	}
	...
	for field, attr := range ParentalcontrolSubscribersiteMspsResourceSchemaAttributes {
