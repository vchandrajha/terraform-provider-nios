...
func (m *ParentalcontrolSubscribersiteSpmsModel) PutExpand(to *parentalcontrol.ParentalcontrolSubscribersiteSpms) *parentalcontrol.ParentalcontrolSubscribersiteSpms {
	if m == nil {
		return nil
	}
	...
	for field, attr := range ParentalcontrolSubscribersiteSpmsResourceSchemaAttributes {
