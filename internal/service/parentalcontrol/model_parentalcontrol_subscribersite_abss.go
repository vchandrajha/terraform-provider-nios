...
func (m *ParentalcontrolSubscribersiteAbssModel) PutExpand(to *parentalcontrol.ParentalcontrolSubscribersiteAbss) *parentalcontrol.ParentalcontrolSubscribersiteAbss {
	if m == nil {
		return nil
	}
	...
	for field, attr := range ParentalcontrolSubscribersiteAbssResourceSchemaAttributes {
