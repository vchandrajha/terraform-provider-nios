...
type Ipv6fixedaddress struct {
	...
	// The dynamic DNS updates flag of a DHCP IPv6 fixed address object. If set to True, the DHCPv6 server sends DDNS updates to DNS servers in the same Grid, and to external DNS servers.
	...
	// IAID associated with Microsoft IPv6 fixed address.
	MsIaid *int64 `json:"ms_iaid,omitempty"`
	// This field contains the Microsoft DHCPv6 options for this IPv6 fixed address.
	MsOptions []Ipv6fixedaddressMsOptions `json:"ms_options,omitempty"`
	MsServer  *Ipv6fixedaddressMsServer   `json:"ms_server,omitempty"`
...
// GetMsIaid returns the MsIaid field value if set, zero value otherwise.
func (o *Ipv6fixedaddress) GetMsIaid() int64 {
	if o == nil || IsNil(o.MsIaid) {
		var ret int64
		return ret
	}
	return *o.MsIaid
...
// GetMsIaidOk returns a tuple with the MsIaid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Ipv6fixedaddress) GetMsIaidOk() (*int64, bool) {
	if o == nil || IsNil(o.MsIaid) {
		return nil, false
	}
	return o.MsIaid, true
}
...
// SetMsIaid gets a reference to the given int64 and assigns it to the MsIaid field.
...
func (o *Ipv6fixedaddress) GetMsOptions() []Ipv6fixedaddressMsOptions {
	if o == nil || IsNil(o.MsOptions) {
		var ret []Ipv6fixedaddressMsOptions
		return ret
	}
	return o.MsOptions
}
...
// SetMsOptions gets a reference to the given []Ipv6fixedaddressMsOptions and assigns it to the MsOptions field.
...
func (o *Ipv6fixedaddress) GetMsServer() Ipv6fixedaddressMsServer {
	if o == nil || IsNil(o.MsServer) {
		var ret Ipv6fixedaddressMsServer
		return ret
	}
	return *o.MsServer
}
...
// SetMsServer gets a reference to the given Ipv6fixedaddressMsServer and assigns it to the MsServer field.
