...
type Ipv6range struct {
	...
	// This field controls whether only the DHCPv6 server is allowed to update DNS, regardless of the DHCPv6 client requests.
	...
	// The dynamic DNS updates flag of a DHCP IPv6 range object. If set to True, the DHCPv6 server sends DDNS updates to DNS servers in the same Grid, and to external DNS servers.
	...
	// This field contains the Microsoft DHCP options for this IPv6 range.
	MsOptions []Ipv6rangeMsOptions `json:"ms_options,omitempty"`
	// This field contains the MS preference for this IPv6 Range.
	MsPreference *int64             `json:"ms_preference,omitempty"`
	MsServer     *Ipv6rangeMsServer `json:"ms_server,omitempty"`
	...
	// This field contains the IPv6 preferred lifetime.
	...
	// This field contains the IPv6 valid lifetime.
...
func (o *Ipv6range) GetAlwaysUpdateDns() bool {
...
// and a boolean to check if the value has been set.
func (o *Ipv6range) GetAlwaysUpdateDnsOk() (*bool, bool) {
	if o == nil || IsNil(o.AlwaysUpdateDns) {
		return nil, false
	}
...
func (o *Ipv6range) HasAlwaysUpdateDns() bool {
	if o != nil && !IsNil(o.AlwaysUpdateDns) {
		return true
	}
...
func (o *Ipv6range) SetAlwaysUpdateDns(v bool) {
	o.AlwaysUpdateDns = &v
}
...
func (o *Ipv6range) GetEnableDdns() bool {
...
// and a boolean to check if the value has been set.
func (o *Ipv6range) GetEnableDdnsOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableDdns) {
		return nil, false
	}
...
func (o *Ipv6range) HasEnableDdns() bool {
	if o != nil && !IsNil(o.EnableDdns) {
		return true
	}
...
func (o *Ipv6range) SetEnableDdns(v bool) {
	o.EnableDdns = &v
}
...
func (o *Ipv6range) GetMsOptions() []Ipv6rangeMsOptions {
	if o == nil || IsNil(o.MsOptions) {
		var ret []Ipv6rangeMsOptions
		return ret
	}
	return o.MsOptions
}
...
// and a boolean to check if the value has been set.
func (o *Ipv6range) GetMsOptionsOk() ([]Ipv6rangeMsOptions, bool) {
	if o == nil || IsNil(o.MsOptions) {
		return nil, false
	}
...
func (o *Ipv6range) HasMsOptions() bool {
	if o != nil && !IsNil(o.MsOptions) {
		return true
	}
...
// SetMsOptions gets a reference to the given []Ipv6rangeMsOptions and assigns it to the MsOptions field.
func (o *Ipv6range) SetMsOptions(v []Ipv6rangeMsOptions) {
	o.MsOptions = v
}

// GetMsPreference returns the MsPreference field value if set, zero value otherwise.
func (o *Ipv6range) GetMsPreference() int64 {
	if o == nil || IsNil(o.MsPreference) {
		var ret int64
		return ret
	}
	return *o.MsPreference
}

// GetMsPreferenceOk returns a tuple with the MsPreference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Ipv6range) GetMsPreferenceOk() (*int64, bool) {
	if o == nil || IsNil(o.MsPreference) {
		return nil, false
	}
	return o.MsPreference, true
}

// HasMsPreference returns a boolean if a field has been set.
func (o *Ipv6range) HasMsPreference() bool {
	if o != nil && !IsNil(o.MsPreference) {
		return true
	}
...
// SetMsPreference gets a reference to the given int64 and assigns it to the MsPreference field.
func (o *Ipv6range) SetMsPreference(v int64) {
	o.MsPreference = &v
}

// GetMsServer returns the MsServer field value if set, zero value otherwise.
func (o *Ipv6range) GetMsServer() Ipv6rangeMsServer {
	if o == nil || IsNil(o.MsServer) {
		var ret Ipv6rangeMsServer
		return ret
	}
	return *o.MsServer
}
...
// and a boolean to check if the value has been set.
func (o *Ipv6range) GetMsServerOk() (*Ipv6rangeMsServer, bool) {
	if o == nil || IsNil(o.MsServer) {
		return nil, false
	}
...
func (o *Ipv6range) HasMsServer() bool {
	if o != nil && !IsNil(o.MsServer) {
		return true
	}
...
// SetMsServer gets a reference to the given Ipv6rangeMsServer and assigns it to the MsServer field.
func (o *Ipv6range) SetMsServer(v Ipv6rangeMsServer) {
	o.MsServer = &v
}
...
func (o *Ipv6range) GetPreferredLifetime() int64 {
...
// and a boolean to check if the value has been set.
func (o *Ipv6range) GetPreferredLifetimeOk() (*int64, bool) {
	if o == nil || IsNil(o.PreferredLifetime) {
		return nil, false
	}
...
func (o *Ipv6range) HasPreferredLifetime() bool {
	if o != nil && !IsNil(o.PreferredLifetime) {
		return true
	}
...
func (o *Ipv6range) SetPreferredLifetime(v int64) {
...
func (o *Ipv6range) GetUseEnableDdns() bool {
...
// and a boolean to check if the value has been set.
func (o *Ipv6range) GetUseEnableDdnsOk() (*bool, bool) {
	if o == nil || IsNil(o.UseEnableDdns) {
		return nil, false
	}
...
func (o *Ipv6range) HasUseEnableDdns() bool {
	if o != nil && !IsNil(o.UseEnableDdns) {
		return true
	}
...
func (o *Ipv6range) SetUseEnableDdns(v bool) {
	o.UseEnableDdns = &v
}
...
func (o *Ipv6range) GetUseMsOptions() bool {
...
// and a boolean to check if the value has been set.
func (o *Ipv6range) GetUseMsOptionsOk() (*bool, bool) {
	if o == nil || IsNil(o.UseMsOptions) {
		return nil, false
	}
...
func (o *Ipv6range) HasUseMsOptions() bool {
	if o != nil && !IsNil(o.UseMsOptions) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Ipv6range) GetUsePreferredLifetimeOk() (*bool, bool) {
	if o == nil || IsNil(o.UsePreferredLifetime) {
		return nil, false
	}
...
func (o *Ipv6range) HasUsePreferredLifetime() bool {
	if o != nil && !IsNil(o.UsePreferredLifetime) {
		return true
	}
...
func (o *Ipv6range) SetUsePreferredLifetime(v bool) {
...
func (o *Ipv6range) GetUseValidLifetime() bool {
...
// and a boolean to check if the value has been set.
func (o *Ipv6range) GetUseValidLifetimeOk() (*bool, bool) {
	if o == nil || IsNil(o.UseValidLifetime) {
		return nil, false
	}
...
func (o *Ipv6range) HasUseValidLifetime() bool {
	if o != nil && !IsNil(o.UseValidLifetime) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Ipv6range) GetValidLifetimeOk() (*int64, bool) {
	if o == nil || IsNil(o.ValidLifetime) {
		return nil, false
	}
...
func (o *Ipv6range) HasValidLifetime() bool {
	if o != nil && !IsNil(o.ValidLifetime) {
		return true
	}
...
func (o *Ipv6range) SetValidLifetime(v int64) {
	o.ValidLifetime = &v
}
...
func (o Ipv6range) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MsPreference) {
		toSerialize["ms_preference"] = o.MsPreference
	}
	if !IsNil(o.MsServer) {
