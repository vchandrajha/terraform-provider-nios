...
func (o *NetworktemplateMembers) GetAddress() string {
...
// and a boolean to check if the value has been set.
func (o *NetworktemplateMembers) GetAddressOk() (*string, bool) {
	if o == nil || IsNil(o.Address) {
		return nil, false
	}
...
func (o *NetworktemplateMembers) HasAddress() bool {
	if o != nil && !IsNil(o.Address) {
		return true
	}
...
func (o *NetworktemplateMembers) SetAddress(v string) {
	o.Address = &v
}
