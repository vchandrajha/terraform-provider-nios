...
func (o *ThreatinsightInsightAllowlist) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *ThreatinsightInsightAllowlist) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *ThreatinsightInsightAllowlist) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *ThreatinsightInsightAllowlist) SetUuid(v string) {
	o.Uuid = &v
}
