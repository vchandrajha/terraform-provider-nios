...
type MemberDhcpproperties struct {
	...
	// Total number of IPs associated with IPv4 DHCP failover associations for the member.
	FailoverAssociationIpCount *int64 `json:"failover_association_ip_count,omitempty"`
	// Failover association utilization percentage.
	FailoverAssociationUtilization *int64 `json:"failover_association_utilization,omitempty"`
	...
	// Maximum number of IPs that can be associated with IPv4 DHCP failover associations for the member.
	MaxFailoverAssociationIpCount *int64 `json:"max_failover_association_ip_count,omitempty"`
...
// GetFailoverAssociationIpCount returns the FailoverAssociationIpCount field value if set, zero value otherwise.
func (o *MemberDhcpproperties) GetFailoverAssociationIpCount() int64 {
	if o == nil || IsNil(o.FailoverAssociationIpCount) {
		var ret int64
		return ret
	}
	return *o.FailoverAssociationIpCount
}

// GetFailoverAssociationIpCountOk returns a tuple with the FailoverAssociationIpCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDhcpproperties) GetFailoverAssociationIpCountOk() (*int64, bool) {
	if o == nil || IsNil(o.FailoverAssociationIpCount) {
		return nil, false
	}
	return o.FailoverAssociationIpCount, true
}
...
// SetFailoverAssociationIpCount gets a reference to the given int64 and assigns it to the FailoverAssociationIpCount field.
func (o *MemberDhcpproperties) SetFailoverAssociationIpCount(v int64) {
	o.FailoverAssociationIpCount = &v
}

// GetFailoverAssociationUtilization returns the FailoverAssociationUtilization field value if set, zero value otherwise.
func (o *MemberDhcpproperties) GetFailoverAssociationUtilization() int64 {
	if o == nil || IsNil(o.FailoverAssociationUtilization) {
		var ret int64
		return ret
	}
	return *o.FailoverAssociationUtilization
}

// GetFailoverAssociationUtilizationOk returns a tuple with the FailoverAssociationUtilization field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDhcpproperties) GetFailoverAssociationUtilizationOk() (*int64, bool) {
	if o == nil || IsNil(o.FailoverAssociationUtilization) {
		return nil, false
	}
	return o.FailoverAssociationUtilization, true
}
...
// SetFailoverAssociationUtilization gets a reference to the given int64 and assigns it to the FailoverAssociationUtilization field.
func (o *MemberDhcpproperties) SetFailoverAssociationUtilization(v int64) {
	o.FailoverAssociationUtilization = &v
}
...
// GetMaxFailoverAssociationIpCount returns the MaxFailoverAssociationIpCount field value if set, zero value otherwise.
func (o *MemberDhcpproperties) GetMaxFailoverAssociationIpCount() int64 {
	if o == nil || IsNil(o.MaxFailoverAssociationIpCount) {
		var ret int64
		return ret
	}
	return *o.MaxFailoverAssociationIpCount
}

// GetMaxFailoverAssociationIpCountOk returns a tuple with the MaxFailoverAssociationIpCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberDhcpproperties) GetMaxFailoverAssociationIpCountOk() (*int64, bool) {
	if o == nil || IsNil(o.MaxFailoverAssociationIpCount) {
		return nil, false
	}
	return o.MaxFailoverAssociationIpCount, true
}
...
// SetMaxFailoverAssociationIpCount gets a reference to the given int64 and assigns it to the MaxFailoverAssociationIpCount field.
func (o *MemberDhcpproperties) SetMaxFailoverAssociationIpCount(v int64) {
	o.MaxFailoverAssociationIpCount = &v
}
...
func (o MemberDhcpproperties) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FailoverAssociationIpCount) {
		toSerialize["failover_association_ip_count"] = o.FailoverAssociationIpCount
	}
	if !IsNil(o.FailoverAssociationUtilization) {
		toSerialize["failover_association_utilization"] = o.FailoverAssociationUtilization
	}
	...
	if !IsNil(o.MaxFailoverAssociationIpCount) {
		toSerialize["max_failover_association_ip_count"] = o.MaxFailoverAssociationIpCount
	}
